...
bool InterfaceKinetics::addReaction(shared_ptr<Reaction> r_base, bool resize)
{
    ...
    std::cout<<rate->usesCoverageDependence()<<std::endl;
    ...
    //     m_has_coverage_dependence = true;
    // }
    // std::cout<<(*rate).type()<<std::endl;
    // std::cout<<r_base->reactantString()<<std::endl;
    // std::cout<<r_base->productString()<<std::endl;
    // std::cout<<rate.get()->usesCoverageDependence()<<std::endl;
