...
class TestReactorJacobians(utilities.CanteraTest):
    ...
    def test_ideal_mole_jacobian(self):
        self.make_reactor()
        # jac = self.net.jacobian
        # fd_jac = self.net.finite_difference_jacobian
        ad_jac = self.net.autodiff_jacobian
        # # check shapes are the same
        # for i in range(self.net.n_vars):
        #      print(jac[i, :])
        #      print(fd_jac[i, :])
        #     # for j in range(self.net.n_vars):
